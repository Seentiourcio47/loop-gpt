...
const SLASH_COMMANDS: SlashCommand[] = [
  ...
  { cmd: '/video', mode: 'agent', label: 'Generate Video', icon: Video, hint: 'Create a video from text or image' },
]
          ...
          <div className="relative">
            ...
            {showPlus && (
              <div className="absolute bottom-full mb-2 left-0 w-52 glass rounded-xl border border-white/[0.08] overflow-hidden z-20 shadow-panel">
                ...
                <PlusItem icon={Video} label="Generate video" onClick={() => { onClosePlus(); onInputChange('/video '); }} />
