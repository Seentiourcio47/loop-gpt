...
import { PanelLeft, FileDown, Cpu, Film, Sparkles } from 'lucide-react'
        ...
        <div className="flex items-center gap-2 px-3 sm:px-4 h-12 border-b border-white/[0.05] shrink-0 bg-[#0a0a12]">
          ...
          <div className="ml-auto flex items-center gap-1">
            ...
            <Link
              href="/create/video"
              title="Create video"
              className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-[12px] border border-white/[0.06] text-slate-500 hover:bg-white/[0.05] hover:text-slate-300 transition"
            >
              <Film size={13} />
